...
var path,boy,cash,diamonds,jewelry,sword,bomb,end;
var pathImg,boyImg,cashImg,diamondsImg,jewelryImg,swordImg,bombImg,endImg;
...
function draw() {
  ...
  if(path.y > 400 ){
    ...
    if (cashG.isTouching(boy)) {
      ...
      if(bombG.isTouching(boy)||(swordG.isTouching(boy))) {
        gameState=END;
